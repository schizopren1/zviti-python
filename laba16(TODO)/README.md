...
___
Мета роботи:Task 1: 
Метою даної роботи було створення ефективної та гнучкої системи управління задачами за допомогою об'єктно-орієнтованого програмування. Система складається з двох основних класів – Task і Schedule, які надають широкі можливості для створення, редагування, сортування, фільтрації, збереження та завантаження задач. Основні цілі включали:
___
Опис завдання:
```Python
Create Task Class
